...
namespace mcts_checkers {
    ...
    std::pair<std::vector<AttackAction>, uint64_t> collect_pawn_attacks(const CheckersData& data, Vector<uint8_t> checker_board_vector);
    std::pair<std::vector<AttackAction>, uint64_t> collect_pawn_attacks(const CheckersData& data, uint8_t checker_index);
