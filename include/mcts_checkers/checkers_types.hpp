...
namespace mcts_checkers {
    ...
    using CheckersIndex = strong::type<uint8_t, struct CheckersIndex_, strong::incrementable, strong::equality>;
    using CheckersBitset = strong::type<std::bitset<CHEKCERS_CELLS_COUNT>, struct CheckersBitset_, strong::indexed<CheckersIndex>>;
}